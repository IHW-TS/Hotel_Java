...
public class ClientRes extends JFrame {
	...
	public ClientRes(String ReservNom, String ReservPrix) {
		...
		JComboBox t1 = new JComboBox(); // type de chambre changer en suite double SP SN avec un controlleur mais
										// impossible de retrouver l'ancien ficher donc a refaire
		t1.addItem("1");
		t1.addItem("2");
		t1.addItem("3");
		t1.addItem("4");
		...
		// Client panel 2
		// création des différentes informations à donner et des espaces pour les
		// rentrer
